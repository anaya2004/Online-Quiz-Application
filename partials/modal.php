                ...
                <form action="./endpoint/add-result.php" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="quizTaker" name="quiz_taker" 
                               ...
                               pattern=".{5,20}" title="Name must be between 5 and 20 characters">
                    </div>
                    <div class="form-group">
                        <label for="yearSection">Year and Section<br><h6>(There must be a single space between year and section)</h6></label>
                        <input type="text" class="form-control" id="yearSection" name="year_section" 
                               required minlength="3"maxlength="6"
                               pattern=".{1,6}" title="Year and Section must be up to 6 characters">
                    </div>
                    <div class="form-group">
